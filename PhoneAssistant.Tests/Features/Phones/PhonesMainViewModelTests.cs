...
public sealed class PhonesMainViewModelTests
{
    ...
    public async Task RefreshPhonesCommand_AfterCRUDChanges_UpdatesViewAsync()
    {
        List<Phone> phones = new List<Phone>() {
            new Phone() { Imei = "1" , AssetTag = "Tag A1", Model = "", NorR = "", OEM = "", Status = ""},
            new Phone() { Imei = "2" , AssetTag = "Tag Bb2", Model = "", NorR = "", OEM = "", Status = ""},
            new Phone() {Imei = "321", AssetTag = "Tag Ccc3", Model = "", NorR = "", OEM = "", Status = ""}
        };
        PhonesMainViewModel vm = ViewModelMockSetup(phones);
        await vm.LoadAsync();
        ICollectionView view = CollectionViewSource.GetDefaultView(vm.PhoneItems);
        index = 0;
        phones.Add(new Phone() { Imei = "444", AssetTag = "Tag ddd4", Model = "", NorR = "", OEM = "", Status = "" });
    ...
    public async Task ChangingFilterAssetTag_ChangesFilterViewAsync()
    {
        List<Phone> phones = new List<Phone>() {
            new Phone() { Imei = "1" , AssetTag = "Tag A1", Model = "", NorR = "", OEM = "", Status = ""},
            new Phone() { Imei = "2" , AssetTag = "Tag Bb2", Model = "", NorR = "", OEM = "", Status = ""},
            new Phone() {Imei = "3", AssetTag = "Tag Ccc3", Model = "", NorR = "", OEM = "", Status = ""}
        };
        PhonesMainViewModel vm = ViewModelMockSetup(phones);
        await vm.LoadAsync();
        ICollectionView view = CollectionViewSource.GetDefaultView(vm.PhoneItems);
    ...
    {
        List<Phone> phones = new List<Phone>() {
            new Phone() { Imei = "1" , FormerUser = "Aa", Model = "", NorR = "", OEM = "", Status = ""},
            new Phone() {Imei = "2", FormerUser = "Bbb", Model = "", NorR = "", OEM = "", Status = ""},
            new Phone() {Imei = "3", FormerUser = "Ccc", Model = "", NorR = "", OEM = "", Status = ""}
        };
        PhonesMainViewModel vm = ViewModelMockSetup(phones);
        await vm.LoadAsync();
        ICollectionView view = CollectionViewSource.GetDefaultView(vm.PhoneItems);
    ...
    {
        List<Phone> phones = new List<Phone>() {
            new Phone() { Imei = "11", Model = "", NorR = "", OEM = "", Status = ""},
            new Phone() {Imei = "22", Model = "", NorR = "", OEM = "", Status = ""},
            new Phone() {Imei = "33", Model = "", NorR = "", OEM = "", Status = ""}
        };
        PhonesMainViewModel vm = ViewModelMockSetup(phones);
        await vm.LoadAsync();
        ICollectionView view = CollectionViewSource.GetDefaultView(vm.PhoneItems);
    ...
    {
        List<Phone> phones = new List<Phone>() {
            new Phone() { Imei = "1", NorR="N", Model = "", OEM = "", Status = ""},
            new Phone() { Imei = "2", NorR="R", Model = "", OEM = "", Status = ""},
            new Phone() {Imei = "3", NorR = "N", Model = "", OEM = "", Status = ""}
        };
        PhonesMainViewModel vm = ViewModelMockSetup(phones);
        await vm.LoadAsync();
        ICollectionView view = CollectionViewSource.GetDefaultView(vm.PhoneItems);
    ...
    {
        List<Phone> phones = new List<Phone>() {
            new Phone() { Imei = "1" , NewUser = "User Aa", Model = "", NorR = "", OEM = "", Status = ""},
            new Phone() {Imei = "2", NewUser = "User Bbb", Model = "", NorR = "", OEM = "", Status = ""},
            new Phone() {Imei = "3", NewUser = "User Ccc", Model = "", NorR = "", OEM = "", Status = ""}
        };
        PhonesMainViewModel vm = ViewModelMockSetup(phones);
        await vm.LoadAsync();
        ICollectionView view = CollectionViewSource.GetDefaultView(vm.PhoneItems);
    ...
    {
        List<Phone> phones = new List<Phone>() {
            new Phone() { Imei = "1" , Notes = "Note1", Model = "", NorR = "", OEM = "", Status = ""},
            new Phone() { Imei = "2" , Notes = "Note2", Model = "", NorR = "", OEM = "", Status = ""},
            new Phone() {Imei = "3", Notes = "Note3", Model = "", NorR = "", OEM = "", Status = ""}
        };
        PhonesMainViewModel vm = ViewModelMockSetup(phones);
        await vm.LoadAsync();
        ICollectionView view = CollectionViewSource.GetDefaultView(vm.PhoneItems);
    ...
    {
        List<Phone> phones = new List<Phone>() {
            new Phone() { Imei = "1" , OEM = "Apple", Model = "", NorR = "", Status = ""},
            new Phone() {Imei = "2", OEM = "Nokia", Model = "", NorR = "", Status = ""},
            new Phone() {Imei = "3", OEM = "Samsung", Model = "", NorR = "", Status = ""}
        };
        PhonesMainViewModel vm = ViewModelMockSetup(phones);
        await vm.LoadAsync();
        ICollectionView view = CollectionViewSource.GetDefaultView(vm.PhoneItems);
    ...
    {
        List<Phone> phones = new List<Phone>() {
            new Phone() {Imei = "1", PhoneNumber = "01", Model = "", NorR = "", OEM = "", Status = ""},
            new Phone() { Imei = "2", PhoneNumber="02", Model = "", NorR = "", OEM = "", Status = ""},
            new Phone() {Imei = "3", PhoneNumber = "03", Model = "", NorR = "", OEM = "", Status = ""}
        };
        PhonesMainViewModel vm = ViewModelMockSetup(phones);
        await vm.LoadAsync();
        ICollectionView view = CollectionViewSource.GetDefaultView(vm.PhoneItems);
    ...
    {
        List<Phone> phones = new List<Phone>() {
            new Phone() {Imei = "1", SimNumber = "101", Model = "", NorR = "", OEM = "", Status = ""},
            new Phone() { Imei = "2", SimNumber="202", Model = "", NorR = "", OEM = "", Status = ""},
            new Phone() {Imei = "3", SimNumber = "303", Model = "", NorR = "", OEM = "", Status = ""}
        };
        PhonesMainViewModel vm = ViewModelMockSetup(phones);
        await vm.LoadAsync();
        ICollectionView view = CollectionViewSource.GetDefaultView(vm.PhoneItems);
    ...
    {
        List<Phone> phones = new List<Phone>() {
            new Phone() { Imei = "1", SR=111, Model = "", NorR = "", OEM = "", Status = ""},
            new Phone() { Imei = "2", SR=222, Model = "", NorR = "", OEM = "", Status = ""},
            new Phone() {Imei = "3", SR = 333, Model = "", NorR = "", OEM = "", Status = ""},
            new Phone() {Imei = "4", SR = 112233, Model = "", NorR = "", OEM = "", Status = ""}
        };
        PhonesMainViewModel vm = ViewModelMockSetup(phones);
        await vm.LoadAsync();
        ICollectionView view = CollectionViewSource.GetDefaultView(vm.PhoneItems);
    ...
    {
        List<Phone> phones = new List<Phone>() {
            new Phone() { Imei = "1", Status="Production", Model = "", NorR = "", OEM = ""},
            new Phone() { Imei = "2", Status="In Stock", Model = "", NorR = "", OEM = ""},
            new Phone() { Imei = "3", Status="In Repair", Model = "", NorR = "", OEM = ""}
        };
        PhonesMainViewModel vm = ViewModelMockSetup(phones);
        await vm.LoadAsync();
        ICollectionView view = CollectionViewSource.GetDefaultView(vm.PhoneItems);
